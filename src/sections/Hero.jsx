    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red mt-3 inline-block mr-3">Nike</span>
          Shoes
        </h1>
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-s">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen bg-cover bg-center max-xl:py-40 bg-primary">
        <img
          src={bigShoeImg}
          alt="big shoe"
          width={610}
